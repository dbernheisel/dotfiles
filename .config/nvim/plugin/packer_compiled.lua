...
_G.packer_plugins = {
  ...
  ["document-color.nvim"] = {
    loaded = true,
    path = "/Users/dbern/.local/share/nvim/site/pack/packer/start/document-color.nvim",
  ...
  ["mason-lspconfig.nvim"] = {
    loaded = true,
    path = "/Users/dbern/.local/share/nvim/site/pack/packer/start/mason-lspconfig.nvim",
    url = "https://github.com/williamboman/mason-lspconfig.nvim"
  },
  ["mason.nvim"] = {
    loaded = true,
    path = "/Users/dbern/.local/share/nvim/site/pack/packer/start/mason.nvim",
